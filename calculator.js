function ProduceTimeTable(){
    ...
    for (let i = 0; i < HtmlCourses.length; i++) {
        ...
        if (CourseSections[i].length != 0 && HtmlCourses[i].value != "Please Select a Course."){
            NumCourses++;
        }
    }
...
function PrintTable(TimeTable){
    ...
    Timings = ["","8.00-9.00","9.00-10.00","10.00-11.00","11.00-12.00","12.00-1.00","1.00-2.00","2.00-3.00","3.00-4.00"]
